...
**技术栈**: Node.js + React + PostgreSQL/MySQL + Redis (可选)
**部署目标**: AWS EC2 + RDS + S3
...
**连接信息**:
```bash
DATABASE_URL=mysql://username:password@your-rds-endpoint.region.rds.amazonaws.com:3306/awareness_market
```
...
# 或 MySQL
# DATABASE_URL=mysql://admin:YOUR_PASSWORD@your-rds-endpoint.us-east-1.rds.amazonaws.com:3306/awareness_market
