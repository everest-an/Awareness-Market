                    ...
                    <div className="space-y-4">
                      <div className="flex items-start gap-4">
                        ...
                        <div className="flex-1">
                          ...
                          <ul className="text-xs text-muted-foreground space-y-1 ml-4">
                            <li>â€?<strong>Vector:</strong> Latent vectors + W-Matrix file + quality metrics</li>
                            <li>â€?<strong>Memory:</strong> KV-Cache snapshot + context description + compression ratio</li>
                            <li>â€?<strong>Chain:</strong> Full KV-Cache sequence + problem/solution examples</li>
                          </ul>
                        </div>
                      </div>
                      ...
                      <div className="flex items-start gap-4">
                        ...
                        <div className="flex-1">
                          ...
                          <ul className="text-xs text-muted-foreground space-y-1 ml-4">
                            <li>â€?<strong>Pricing:</strong> Per-call ($0.01-$50) or Monthly subscription ($5-$500)</li>
                            <li>â€?<strong>Metadata:</strong> Tags, source model, target models, training dataset</li>
                            <li>â€?<strong>Examples:</strong> Input/output samples to showcase capabilities</li>
                          </ul>
                        </div>
                      </div>
                      ...
                      <div className="flex items-start gap-4">
                        ...
                        <div className="flex-1">
                          ...
                          <ul className="text-xs text-muted-foreground space-y-1 ml-4">
                            <li>â€?<strong>Revenue:</strong> Real-time earnings and payout history</li>
                            <li>â€?<strong>Analytics:</strong> Download count, API calls, user ratings</li>
                            <li>â€?<strong>Optimization:</strong> A/B test pricing, update descriptions</li>
                          </ul>
                        </div>
                      </div>
                    </div>
                    ...
                    <div className="space-y-4">
                      <div className="flex items-start gap-4">
                        ...
                        <div className="flex-1">
                          ...
                          <ul className="text-xs text-muted-foreground space-y-1 ml-4">
                            <li>â€?<strong>By Category:</strong> Translation, Code Gen, Analysis, etc.</li>
                            <li>â€?<strong>By Model:</strong> GPT-4, Claude, LLaMA, Gemini compatibility</li>
                            <li>â€?<strong>By Price:</strong> Free, per-call, or subscription</li>
                            <li>â€?<strong>By Rating:</strong> User reviews and quality scores</li>
                          </ul>
                        </div>
                      </div>
                      ...
                      <div className="flex items-start gap-4">
                        ...
                        <div className="flex-1">
                          ...
                          <ul className="text-xs text-muted-foreground space-y-1 ml-4">
                            <li>â€?<strong>Payment:</strong> Credit card or crypto (ETH, USDC)</li>
                            <li>â€?<strong>Download:</strong> Vector files, KV-Cache snapshots, or API access</li>
                            <li>â€?<strong>License:</strong> Commercial use, attribution requirements</li>
                          </ul>
                        </div>
                      </div>
                      ...
                      <div className="flex items-start gap-4">
                        ...
                        <div className="flex-1">
                          ...
                          <ul className="text-xs text-muted-foreground space-y-1 ml-4">
                            <li>â€?<strong>Vector:</strong> <code className="text-xs bg-muted px-1 rounded">load_vector(package_id)</code></li>
                            <li>â€?<strong>Memory:</strong> <code className="text-xs bg-muted px-1 rounded">load_memory(package_id)</code></li>
                            <li>â€?<strong>Chain:</strong> <code className="text-xs bg-muted px-1 rounded">replay_chain(package_id)</code></li>
                          </ul>
                        </div>
                      </div>
                    </div>
